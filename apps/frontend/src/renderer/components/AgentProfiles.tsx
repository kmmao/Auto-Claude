      ...
      >
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold text-foreground">{t(`settings:agent.profiles.${profile.id}.name`)}</h3>
            <p className="mt-1 text-sm text-muted-foreground">
              {t(`settings:agent.profiles.${profile.id}.description`)}
            </p>
    ...
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="shrink-0 border-b border-border bg-background px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-foreground">{t('settings:agent.profile.title')}</h1>
            <p className="mt-1 text-sm text-muted-foreground">
              {t('settings:agent.profile.description')}
            </p>
          </div>
        </div>
      </div>
