...
export function WelcomeStep({ onGetStarted, onSkip }: WelcomeStepProps) {
  ...
  const features = [
    ...
    },
    {
      ...
      title: t('onboarding:welcome.features.spec.title'),
      description: t('onboarding:welcome.features.spec.description')
    },
    {
      icon: <Brain className="h-5 w-5" />,
      title: t('onboarding:welcome.features.memory.title'),
      description: t('onboarding:welcome.features.memory.description')
    },
    {
      icon: <Zap className="h-5 w-5" />,
      title: t('onboarding:welcome.features.parallel.title'),
      description: t('onboarding:welcome.features.parallel.description')
    }
  ];
