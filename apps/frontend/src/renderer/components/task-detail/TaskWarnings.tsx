          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-medium text-sm text-foreground mb-1">
                {t('taskDetail:warnings.stuckTitle')}
              </h3>
              <p className="text-sm text-muted-foreground mb-3">
                {t('taskDetail:warnings.stuckDescription')}
              </p>
              <Button
                variant="warning"
                size="sm"
              ...
              >
                {isRecovering ? (
                  ...
                  <>
                    ...
                    {t('taskDetail:warnings.recoverRestart')}
                  </>
                )}
              </Button>
            </div>
      ...
      {isIncomplete && !isStuck && (
        <div className="rounded-xl border border-orange-500/30 bg-orange-500/10 p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-medium text-sm text-foreground mb-1">
                {t('taskDetail:warnings.incompleteTitle')}
              </h3>
              <p className="text-sm text-muted-foreground mb-3">
                {t('taskDetail:warnings.incompleteDescription', { completed: taskProgress.completed, total: taskProgress.total })}
              </p>
              <Button
                variant="default"
                size="sm"
