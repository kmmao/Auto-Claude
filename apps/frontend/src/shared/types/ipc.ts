...
export interface ElectronAPI {
  ...
  stashAndMergeWorktree: (taskId: string, options?: { noCommit?: boolean }) => Promise<IPCResult<WorktreeMergeResult>>;
  forceMergeWorktree: (taskId: string) => Promise<IPCResult<WorktreeMergeResult>>;
